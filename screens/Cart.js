    ...
    <Layout>
      ...
      {cartItems.length > 0 && (
        <>
          ...
          <View>
          <PriceTable title={'Precio'} price={roundToTwoDecimals(totalPrice)} />
            <PriceTable title={'IVA'} price={roundToTwoDecimals(totalPrice * 0.21)} />
            <View style={styles.grandTotal}>
              <PriceTable title={'Total'} price={roundToTwoDecimals(totalPrice * 1.21)} />
            </View>
            <TouchableOpacity
